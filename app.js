...
function generarSospechaECG() {
    ...
    const imgMap = [
        ...
        { match: /isquemia subendoc[áa]rdica|\bnstemi\b/i, src: 'img/nstemi-12-lead.jpg', alt: 'NSTEMI / isquemia subendocárdica (12 derivaciones)' },
        { match: /infarto con elevaci[óo]n del st|\bstemi\b/i, src: 'img/stemi-12-lead.jpg', alt: 'STEMI (12 derivaciones)' },
